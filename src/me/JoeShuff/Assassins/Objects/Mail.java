...
/**
 * Created by joeshuff on 09/07/2016.
 */
import java.io.File;
...
public class Mail extends javax.mail.Authenticator {
    ...
    public static void sendMail(String to, String subject, String message, List<String> attachmentStrings, List<String> names)
    {
    	if (to.contains("null")) {return;}
    	
    	final Mail m = new Mail(EMAIL,PASSWORD);
        ...
        for (int i = 0 ; i < i + 1; i ++)
        {
            try {
            	...
            	if (attachmentStrings.get(i).equals(""))
            	{
            		continue;
            	}
            	
    			m.addAttachment(attachmentStrings.get(i).replace("\\", "/").replace("%20", " "),names.get(i));
